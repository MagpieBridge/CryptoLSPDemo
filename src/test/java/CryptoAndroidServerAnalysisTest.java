...
public class CryptoAndroidServerAnalysisTest {
  ...
  public void test() {
    ...
    String apkFile
        = projectDir + File.separator + "src\\test\\resources\\CryptoAndroidApp\\app\\build\\outputs\\apk\\debug\\app-debug.apk";
    Set<String> srcPath = new HashSet<String>();
    Set<String> libPath = new HashSet<String>();
    srcPath.add(projectDir + File.separator + "src\\test\\resources\\CryptoAndroidApp\\app\\build\\generated\\source");
